...
contract ERC20 is IERC20 {
    ...
    function burn(
        address _from,
        uint amount
    ) public onlyOwner enoughTokens(_from, amount) {
    ...
    function allowance(
        ...
        return allowances[_owner][spender]; // Я владелец, разрешаю списать amount с моего счёта
    }
    ...
    function _approve(
        ...
        allowances[sender][spender] = amount; // С адреса сендер в пользу адреса спендер списать емоунт токенов
